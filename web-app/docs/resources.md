...
<div class="resources-section">
  ...
  <div class="paper-container">
    <div class="paper-box">
      <a href="https://repositorio.uniandes.edu.co/entities/publication/88064863-11e6-4712-b528-442b94aecdce" target="_blank">
        <h3>Data-Centric Strategies for Low-Resource Neural Machine Translation in Colombian Indigenous Languages</h3>
        <p><strong>Summary:</strong> Neural machine translation for Colombian Indigenous languages is limited by small, domain-skewed parallel corpora and by a measurement problem: when training data contains many repeated target sentences, reference-based metrics reward verbatim retrieval of training targets rather than genuine translation—a behavior termed rogue memorization. This work studies three data-centric interventions on the training corpora of Spanish-to-Indigenous-language systems for Wayuunaiki, Nasa Yuwe, Inga, and Kamëntsá, keeping the model architecture fixed and the tokenization procedure identical across experiments, and fine-tuning NLLB-200 dense checkpoints. The first intervention expands the parallel corpora with literary, educational, and community material and maintains source-filtered variants. The second applies backtranslation to Wayuunaiki from a monolingual Wayuunaiki corpus. The third replaces repeated Spanish targets in the biblical subsets of Wayuunaiki with alternative renderings drawn from five public Bible versions. Models are evaluated with SacreBLEU and chrF2 on the original test partitions and, for Wayuunaiki, with an embedding-based nearest-neighbour study that estimates how close generated outputs sit to training targets. Evidence shows that corpus expansion yields uneven gains driven by genre diversity rather than corpus size, that backtranslation improves reference metrics while tightening the coupling between outputs and memorized training targets, and that rephrasing the repeated Spanish side produces a directionally asymmetric drop in BLEU that quantifies the portion of the original score that corresponded to memorized retrieval rather than translation.</p>
        <p><strong>Cite:</strong> Camilo Andrés Cáceres. 2025. Data-Centric Strategies for Low-Resource Neural Machine Translation in Colombian Indigenous Languages. Master's thesis, Universidad de los Andes. https://repositorio.uniandes.edu.co/entities/publication/88064863-11e6-4712-b528-442b94aecdce</p>
      <a href="https://repositorio.uniandes.edu.co/entities/publication/88064863-11e6-4712-b528-442b94aecdce" target="_blank">Read the full thesis</a>
      </a>
    </div>
    <div class="paper-box">
